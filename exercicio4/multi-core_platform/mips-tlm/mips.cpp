...
#undef AC_SYSC
    ...
    default:
      ...
      if ( !ins_cache->valid ){
        quant = 0;
        ins_cache->instr_p = new ac_instr<mips_parms::AC_DEC_FIELD_NUMBER>((ISA.decoder)->Decode(reinterpret_cast<unsigned char*>(buffer), quant));
        ins_cache->valid = 1;
      }
      ...
      case 1: // Instruction lb
        if (!ac_annul_sig) ISA._behavior_mips_Type_I(instr_vec->get(1), instr_vec->get(2), instr_vec->get(3), instr_vec->get(7));
      ...
      case 21: // Instruction add
        if (!ac_annul_sig) ISA._behavior_mips_Type_R(instr_vec->get(1), instr_vec->get(2), instr_vec->get(3), instr_vec->get(4), instr_vec->get(5), instr_vec->get(6));
      ...
      case 46: // Instruction j
        if (!ac_annul_sig) ISA._behavior_mips_Type_J(instr_vec->get(1), instr_vec->get(8));
